...
setup(
    ...
    package_data={'PyPoE': ['_data/*']},
    # Although 'package_data' is the preferred approach, in some case you may
    # need to place data files outside of your packages. See:
    # http://docs.python.org/3.7/distutils/setupscript.html#installing-additional-files # noqa
    ...
    entry_points={  # TODO
        'console_scripts': ['pypoe_exporter=PyPoE.cli.exporter.core:main'],
        'gui_scripts': ['pypoe_ui=PyPoE.ui:main'],
    },
)
