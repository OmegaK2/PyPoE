...
specification = Specification({
    ...
    'AfflictionSplitDemons.dat': File(
        fields=OrderedDict((
            ...
            ('AfflictionRandomModCategoriesKey', Field(
