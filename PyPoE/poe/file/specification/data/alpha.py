...
specification = Specification({
    ...
    'BetrayalJobLeaderDrops.dat': File(
        fields=OrderedDict((
            ('BetrayalJobsKey', Field(
                type='ulong',
                key='BetrayalJobs.dat',
    ...
    'BetrayalSpecificUnveiledMods.dat': File(
        fields=OrderedDict((
            ('ModsKey', Field(
                type='ulong',
                key='Mods.dat',
