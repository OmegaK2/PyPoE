...
specification = Specification({
    ...
    'CharacterStartStates.dat': File(
        fields=OrderedDict((
            ...
            ('Normal_CharacterStartQuestStateKeys', Field(
                type='ref|list|ulong',
                key='CharacterStartQuestState.dat',
            )),
            ('Cruel_CharacterStartQuestStateKeys', Field(
                type='ref|list|ulong',
                key='CharacterStartQuestState.dat',
            )),
            ('Merciless_CharacterStartQuestStateKeys', Field(
                type='ref|list|ulong',
                key='CharacterStartQuestState.dat',
            )),
            ('Unknown', Field(
    ...
    'LabyrinthSectionLayout.dat': File(
        fields=OrderedDict((
            ...
            ('LabyrinthNodeOverridesKey', Field(
                type='ulong',
    ...
    'MapPins.dat': File(
        fields=OrderedDict((
            ...
            ('NormalWaypoint_WorldAreasKey', Field(
                type='ulong',
                key='WorldAreas.dat',
            )),
            ('Normal_WorldAreasKeys', Field(
            ...
            ('CruelWaypoint_WorldAreasKey', Field(
                type='ulong',
                key='WorldAreas.dat',
            )),
            ('MercilessWaypoint_WorldAreasKey', Field(
                type='ulong',
                key='WorldAreas.dat',
            )),
            ('Index3', Field(
    ...
    'MonsterVarieties.dat': File(
        fields=OrderedDict((
            ...
            ('AchievementItemsKey4', Field(
                type='ref|list|ulong',
                key='AchievementItems.dat',
            )),
            ('Normal_ModsKeys', Field(
                type='ref|list|ulong',
                key='Mods.dat',
            )),
            ('Cruel_ModsKeys', Field(
                type='ref|list|ulong',
                key='Mods.dat',
            )),
            ('Merciless_ModsKeys', Field(
                type='ref|list|ulong',
                key='Mods.dat',
            )),
            ('KillRareInNormal_AchievementItemsKeys', Field(
                type='ref|list|ulong',
                key='AchievementItems.dat',
            )),
            ('KillRareInCruel_AchievementItemsKeys', Field(
                type='ref|list|ulong',
                key='AchievementItems.dat',
            )),
            ('KillRareInMerciless_AchievementItemsKeys', Field(
                type='ref|list|ulong',
                key='AchievementItems.dat',
            )),
            ('Key3', Field(
            ...
            ('CountKills_AchievementItemsKeys', Field(
                type='ref|list|ulong',
                key='AchievementItems.dat',
            )),
        )),
    ...
    'NormalDifficultyMasterWeights.dat': File(
        fields=OrderedDict((
            ('MasterID', Field(
                type='int',
            )),
    ...
    'Prophecies.dat': File(
        fields=OrderedDict((
            ...
            ('SealCost_Normal', Field(
                type='int',
            )),
            ('SealCost_Cruel', Field(
                type='int',
            )),
            ('SealCost_Merciless', Field(
                type='int',
            )),
            ('Flag1', Field(
                type='bool',
    ...
    'WorldAreas.dat': File(
        fields=OrderedDict((
            ...
            ('8ModsFullClear_AchievementItemsKey', Field(
                type='ulong',
                key='AchievementItems.dat',
            )),
            ('Unknown77', Field(
