...
abbreviations = {
    ...
    'Can use Items requiring up to level x': 'max. Item level',
    'Chains x Times': '# Chains',
    'Creates Corpses up to Level x': 'Corpse Level',
    'Cursed enemies are x% slower': '% slower',
    'Cursed enemies deal x% less Damage': 'less Damage',
    ...
    'Cursed enemies grant x% more Physical Melee Damage on Melee hit': 'more Physical Damage<br>per Melee hit',
    ...
    'Deals x Base Chaos Damage per second': 'Chaos Damage<br>per second',
    'Deals x Fire Damage per second': 'Fire Damage<br>per second',
    'Deals x% of Base Damage': '% Base Damage',
    ...
    'Deals x-y base Cold Damage per Frenzy Charge': 'Cold Damage<br>per Frenzy Charge',
    'Deals x-y base Fire Damage per Endurance Charge': 'Fire Damage<br>per Endurance Charge',
    'Deals x-y base Lightning Damage per Power Charge': 'Lightning Damage<br>per Power Charge',
    'Enemy Block Chance reduced by x% against this Skill': 'reduced<br>BlockChance',
    'Enemy Dodge Chance reduced by x% against this Skill': 'reduced<br>Dodge Chance',
    'Explosion deals x-y Base Fire damage per Fuse Charge': 'Fire<br>Damage<br>per Fuse',
    'Freezes enemies as though dealing x% more Damage': '% more Damage',
    'Gain Onslaught for x seconds on Killing a Shocked Enemy': 'Onslaught<br>Duration',
    'Gain x% of Cold Damage as Extra Fire Damage': '% of Cold Damage<br>as Extra Fire',
    'Gain x% of Physical Damage as Extra Chaos Damage': '% of Physical Damage<br>as Extra Chaos Damage',
    'Gain x% of Physical Damage as Extra Lightning Damage': '% of Physical Damage<br>as Extra Lightning Damage',
    'Gain x% of your Physical Damage as Extra Fire Damage': '% of Physical Damage<br>as Extra Fire Damage',
    ...
    'Ignites for x% of Overkill Damage': 'Ignites for x%<br> of Overkill Damage',
    ...
    'Minions have x% increased Attack Speed': 'increased<br>Attack Speed',
    'Minions have x% increased Cast Speed': 'increased<br>Cast Speed',
    'Minions have x% increased Movement Speed': 'increased<br>Movement Speed',
    'Minions have x% less Energy Shield': 'less<br>Energy Shield',
    ...
    'Supported Triggered Spells have x% increased Spell Damage': 'increased<br>Spell Damage',
    'Supported skills deal x% less Damage': 'less<br>Damage',
    'This Gem can only Support Skill Gems requiring Level x or lower': 'max. Item Level',
    ...
    'You and nearby allies gain x additional Energy Shield': 'Energy Shield',
    'You and nearby allies gain x additional Evasion Rating': 'Evasion Rating',
    ...
    'You and nearby allies gain x% of your Physical Damage as Extra Cold Damage': ' of Physical Damage<br>as Extra Cold Damage',
    ...
    'x to Level of Supported Active Skill Gems': '+Level',
    ...
    'x% increased Area of Effect radius': 'inc. AoE Radius',
    'x% increased Attack Speed': 'inc. Attack Speed',
    'x% increased Blinding duration': 'inc. Blind<br>Duration',
    'x% increased Buff Duration Per Endurance Charge': 'inc. Duration<br>per Endurance Charge',
    'x% increased Burning Damage': 'inc. Burning Damage',
    'x% increased Cast Speed': 'inc. Cast Speed',
    'x% increased Character Size': 'inc. Character Size',
    'x% increased Chill Duration on enemies': 'inc. Chill Duration',
    'x% increased Critical Strike Chance': 'inc. Critical Chance',
    'x% increased Critical Strike Multiplier': 'inc. Critical Multiplier',
    'x% increased Damage': 'inc. Damage',
    'x% increased Damage per one hundred nearby Enemies': 'inc. Damage<br>per hundred enemies',
    'x% increased Duration ': 'inc. Duration',
    'x% increased Life Leeched per second': 'inc. Life<br>leeched',
    'x% increased Mana Leeched per second': 'inc. Mana<br>leeched',
    'x% increased Melee Physical Damage': 'inc. Melee<br>Physical<br>Damage',
    'x% increased Minion Damage': 'inc. Minion<br>Damage',
    'x% increased Minion Maximum Life': 'inc. Minion<br>Maximum Life',
    'x% increased Minion Movement Speed': 'inc. Minion<br>Movement Speed',
    'x% increased Movement Speed': 'inc. Movement Speed',
    'x% increased Projectile Damage': 'inc. Projectile Damage',
    'x% increased Projectile Speed': 'inc. Projectile Speed',
    'x% increased Quantity of Items Dropped by Slain Enemies': 'inc. Quantity',
    'x% increased Rarity of Items Dropped by Slain Enemies': 'inc. Rarity',
    'x% increased Spell Damage': 'inc. Spell Damage',
    'x% increased effect of Aura': 'inc. Aura<br>Effect',
    'x% increased maximum Life': 'inc. max. Life',
    'x% increased totem life': 'inc. Totem Life',
    'x% less Damage': 'less Damage',
    'x% less Damage to main target': 'less Damage<br>(main)',
    'x% less Damage to other targets': 'less Damage<br>(other)',
    'x% less Fire Damage taken when Hit': 'less Fire<br>Damage taken',
    'x% less Physical Damage taken when Hit': 'less Physical<br>Damage taken',
    'x% less Projectile Damage': 'less Projectile Damage',
    'x% less Projectile Speed': 'less Projectile Speed',
    'x% less Skill Effect Duration': 'less Duration',
    'x% more Area Damage': 'more Area Damage',
    'x% more Cast Speed': 'more Cast Speed',
    'x% more Damage against Chilled Enemies': 'more Damage<br>vs. chilled',
    'x% more Damage at Maximum Charge Distance': 'more Damage<br>at max. distance',
    'x% more Damage per Repeat': 'more Damage<br>per repeat',
    'x% more Damage while Dead': 'more Damage<br>while dead',
    'x% more Melee Attack Speed': 'more Melee<br>Attack Speed',
    'x% more Melee Physical Damage': 'more Melee<br>Physical Damage',
    'x% more Melee Physical Damage against Bleeding Enemies': 'more Melee<br>Physical Damage<br>vs. bleeding',
    'x% more Melee Physical Damage when on Full Life': 'more Melee<br>Physical Damage<br>on full Life',
    'x% more Mine Damage': 'more Mine Damage',
    'x% more Physical Projectile Attack Damage': 'more Physical Projectile<br>Attack Damage',
    'x% more Projectile Damage': 'more Projectile Damage',
    'x% more Spell Damage': 'more Spell Damage',
    'x% more Trap Damage': 'more Trap Damage',
    'x% more Trap and Mine Damage': 'more Trap & Mine Damage',
    'x% more Weapon Elemental Damage': 'more Weapon<br>Elemental Damage',
    'x% reduced Curse Duration': 'reduced<br>Curse Duration',
    'x% reduced Enemy Stun Threshold': 'reduced<br>Stun Threshold',
    'x% reduced Mana Cost': 'reduced<br>Mana Cost',
    'x% reduced Movement Speed': 'reduced<br>Movement Speed',
    'x% reduced Movement Speed per Nearby Enemy': 'reduced<br>Movement Speed<br>per nearby enemy',
    'x% to Quality of Supported Active Skill Gems': '+% Gem Quality',
}
